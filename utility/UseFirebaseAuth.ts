...
const formatIdTokenResult = (token: any, claims: { user_id: any; email: any; name: any, permission: any}) => ({
  uid: claims.user_id,
  email: claims.email,
  name: claims.name,
  token: token,
...
export default function useFirebaseAuth() {
  ...
  const authStateChanged = async (authState: any) => {
    ...
    var formattedUser = formatIdTokenResult(formatIdToken.token, formatIdToken.claims)
