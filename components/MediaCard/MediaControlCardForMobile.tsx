...
export default function MediaControlCardForMobile({
  content,
  setAudioUrl,
  audioUrl,
  onPlay,
    ...
    >
      ...
      >
        ...
        <Stack flexDirection='row' sx={{ mt: '1px' }}>
          ...
          >
            {showButton
              ? content.artist.length > 5
                ? content.artist.substring(0, 5) + '...'
                : content.artist
              : content.artist.length > 15
              ? content.artist.substring(0, 15) + '...'
              : content.artist}
          </Typography>
        </Stack>
        <Stack flexDirection='row' sx={{ mt: '1px' }}>
          ...
          >
            {showButton
              ? content.style.length > 5
                ? content.style.substring(0, 5) + '...'
                : content.style
              : content.style.length > 16
              ? content.style.substring(0, 16) + '...'
              : content.style}
          </Typography>
        </Stack>
        <Stack flexDirection='row' sx={{ mt: '1px' }}>
          ...
          >
            {showButton
              ? content.requirement.length > 5
                ? content.requirement.substring(0, 5) + '...'
                : content.requirement
              : content.requirement.length > 9
              ? content.requirement.substring(0, 10) + '...'
              : content.requirement}
          </Typography>
        </Stack>
        <Stack
